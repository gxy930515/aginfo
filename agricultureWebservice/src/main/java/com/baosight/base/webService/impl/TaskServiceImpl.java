...
import com.baosight.base.task.QuartzJobFactory;
import com.baosight.base.task.QuartzJobFactoryDisallowConcurrentExecution;
...
import com.baosight.base.webService.TaskService;
...
//		System.out.println(scheduleJobMapper.selectByExample(new ScheduleJobQuery()));
	...
	public void addTask(ScheduleJob job) {
		job.setCreateTime(DateFormatUtil.DataTimeToString(new Date()));
	...
	public void init() throws Exception {
		...
		// 这里获取任务信息数据
		List<ScheduleJob> jobList = scheduleJobMapper.selectByExample(new ScheduleJobQuery());
